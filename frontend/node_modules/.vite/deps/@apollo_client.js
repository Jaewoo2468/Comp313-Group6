...
function useSuspenseFragment_(options) {
  ...
  var _a = import_rehackt.default.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a[0], setPromise = _a[1];
